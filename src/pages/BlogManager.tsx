  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-display font-bold tracking-tight">Blog Manager</h1>
          <p className="text-muted text-sm">Orchestrate your semantic cocoon and content inventory.</p>
        </div>
